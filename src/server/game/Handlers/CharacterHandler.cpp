...
void WorldSession::HandlePlayerLogin(LoginQueryHolder* holder)
{
    ...
    if (firstLogin) {
        CharacterDatabase.PExecute("INSERT INTO battleroyale_players_stats (guid, type) VALUES ('%u', 0)", _player->GetSession()->GetAccountId());
        CharacterDatabase.PExecute("INSERT INTO battleroyale_players_stats (guid, type) VALUES ('%u', 2)", _player->GetSession()->GetAccountId());
        CharacterDatabase.PExecute("INSERT INTO battleroyale_players_stats (guid, type) VALUES ('%u', 3)", _player->GetSession()->GetAccountId());
        CharacterDatabase.PExecute("INSERT INTO battleroyale_players_stats (guid, type) VALUES ('%u', 4)", _player->GetSession()->GetAccountId());
    }
