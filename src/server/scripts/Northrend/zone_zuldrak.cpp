...
class npc_invisible_btr_area : public CreatureScript
{
public:
    npc_invisible_btr_area() : CreatureScript("npc_invisible_btr_area") { }

    struct npc_invisible_btr_areaAI : public ScriptedAI
    {
        npc_invisible_btr_areaAI(Creature* creature) : ScriptedAI(creature) { }
    ...
    {
        return new npc_invisible_btr_areaAI(creature);
    }
};
